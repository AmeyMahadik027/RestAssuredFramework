...
import api.endpoints.UserEndPointsThroughPropertiesFile;
...
public class UserTestThroughPropertiesFile {
	...
	public void testPostUser() {
		...
		Response res = UserEndPointsThroughPropertiesFile.createUser(userPayload);
		res.then().log().body();
	...
	public void testGetUser() {
		...
		Response res = UserEndPointsThroughPropertiesFile.readUser(this.userPayload.getUsername());
		res.then().log().body();
	...
	public void testUpdateUserByName() {
		...
		Response res = UserEndPointsThroughPropertiesFile.updateUser(this.userPayload.getUsername(), userPayload);
		res.then().log().body();
		Assert.assertEquals(res.getStatusCode(), 200);
		logger.info("***************User Info Updated**********************");
		// After Updating details verify it from console
		Response resafterupdate = UserEndPointsThroughPropertiesFile.readUser(this.userPayload.getUsername());
		res.then().log().body();
		Assert.assertEquals(res.statusCode(), 200);
	...
	public void testDeleteByName() {
		...
		Response res = UserEndPointsThroughPropertiesFile.deleteUser(this.userPayload.getUsername());
